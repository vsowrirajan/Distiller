...
public abstract class BaseInputParameter {
	...
	protected BaseInputParameter(String name, String description, boolean isRequired, Object defaultValue) {
		m_name = name;
	...
	protected BaseInputParameter(String name, String description, boolean isRequired, boolean isValueRequired) {
		m_name = name;
		m_description = description;
		m_required = isRequired;
		m_defaultValue = null;
