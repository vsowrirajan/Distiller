...
public class BooleanInputParameter extends BaseInputParameter {
  ...
  private static final List<String> trueValues = Arrays.asList(new String[] {
      "t", "true", "yes", "y", "1" });
  private static final List<String> falseValues = Arrays.asList(new String[] {
      "f", "false", "no", "n", "0" });
  ...
  public String getParameterDefaultValueAsString() {
    if (m_defaultValue != null) {
      ...
      } else if (booleanMap.get(Boolean.FALSE).contains(
