...
public class LongInputParameter extends BaseInputParameter {
  ...
  private static final Logger LOG = LoggerFactory
      .getLogger(LongInputParameter.class);
  ...
  public Object valueOf(String value) {
    ...
    try {
      ...
      /**
       * /** <MAPR_ERROR> Message:Value: <value> is not Long
       * Function:LongInputParameter.valueOf() Meaning:A non-long value was
       * passed to a parameter that requires type Long. Resolution:Check the
       * command syntax, and make sure to pass the correct type and a valid
       * value to each parameter. </MAPR_ERROR>
       */
  ...
  public boolean isWithinBoundaries(String value) {
    ...
    if (m_minValue != null && m_maxValue != null) {
      if (m_minValue.longValue() <= longValue.longValue()
          && longValue.longValue() <= m_maxValue.longValue()) {
        return true;
      }
    }
    return true;
