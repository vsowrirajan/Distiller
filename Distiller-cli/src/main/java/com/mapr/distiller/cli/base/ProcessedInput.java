...
public class ProcessedInput {
  ...
  private static final Logger LOG = LoggerFactory
      .getLogger(ProcessedInput.class);
  ...
  private void parseOutInput() {
    if (rawInput == null || rawInput.length < 1) {
      /**
       * <MAPR_ERROR> Message:No input parameters were provided.
       * Function:ProcessedInput.parseOutInput() Meaning:The command requires
       * input parameters. Resolution:Check the command syntax, and make sure to
       * pass the correct parameters. </MAPR_ERROR>
       */
  ...
  public String getStringValueParameter(CLICommand cmd, String name,
      int position) {
    Parameter p = parameters.get(name);
  ...
  public static final class Parameter {
    ...
    public String toString() {
      return new String("ParamName: " + paramName + " ParamValues: "
