...
public class CommandLineOutput extends CommandOutput {
	...
	public CommandLineOutput(byte [] buf) {
		super(buf);
	}
	 ...
	 * @param count
	 */
	private void parseNode(OutputNode node, boolean isHeaderNeeded, Map<String,ColumnData> output, int count) {
	...
	/**
	 * Helper method to produce String output based on List<ColumnData> data structure
	 * @param output
	 * @return
	 */
	private String formatOutput(Map<String, ColumnData> output, boolean isHeaderNeeded) {
		StringBuilder sb = new StringBuilder();
