...
public class IntegerInputParameter extends BaseInputParameter {
	...
	public Object valueOf(String value) {
       ...
       * Function:IntegerInputParameter.valueOf()
       * Meaning:A non-integer value was passed to a parameter that requires a value of type Integer.
	...
	public boolean isWithinBoundaries(String value) {
		...
		if ( m_minValue != null && m_maxValue != null ) {
			if ( m_minValue.intValue() <= intValue.intValue() && intValue.intValue() <= m_maxValue.intValue() ) {
				return true;
			}
		}
		return true;
