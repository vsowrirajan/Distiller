...
public class JSONObjectInputParameter extends BaseInputParameter {
  ...
  private static final Logger LOG = LoggerFactory
      .getLogger(JSONObjectInputParameter.class);
  ...
  public JSONObject valueOf(String value) {
    ...
    try {
      ...
      /**
       * <MAPR_ERROR> Message:Provided input can not be converted to JSONObject:
       * <value> Function:JSONObjectInputParameter.valueOf() Meaning:An internal
