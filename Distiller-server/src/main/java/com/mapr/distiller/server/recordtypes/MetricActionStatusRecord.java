...
public class MetricActionStatusRecord extends Record {
	...
	private long 	inputRecords,					//The number of Records taken from the input queue
					...
					processingFailures,				//The number of calls to the RecordProcessor method that did not return successfully
					queuePutFailures,				//The number of calls to put a Record into the output RecordQueue that did not return successfully
	...
	public MetricActionStatusRecord(String producerId, long inputRecords, long outputRecords, long processingFailures,
			long queuePutFailures, long otherFailures, long runningTimems, long startTime){
