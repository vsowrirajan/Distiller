...
import com.mapr.distiller.server.processors.DiskstatRecordProcessor;
...
public class DiskstatMetricAction extends MetricAction {

	private DiskstatMetricAction(String id, String recordType,
	...
	public static DiskstatMetricAction getInstance(MetricConfig metricConfig,
			RecordQueueManager queueManager) {
		RecordProcessor<Record> recordProcessor = new DiskstatRecordProcessor();
		return new DiskstatMetricAction(metricConfig.getId(),
