...
public class ProcessResourceRecordProcessor implements RecordProcessor<Record> {
	...
	public DifferentialValueRecord diff(Record rec1, Record rec2, String metric)
		...
		if (rec1.getPreviousTimestamp() == -1l
			...
			throw new Exception(
					"ProcessResourceRecords can only be diff'd from non-raw ProcessResourceRecords");
		...
		if (oldRecord.get_starttime() != newRecord.get_starttime()
				|| oldRecord.get_pid() != newRecord.get_pid())
			throw new Exception(
					"Can not calculate diff for input records that are from different processes");
		...
		case "num_threads":
			return new DifferentialValueRecord(
					...
					getName(), metric, "int", newRecord.get_num_threads()
							- oldRecord.get_num_threads());

		case "cpuUtilPct":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getCpuUtilPct()
							- oldRecord.getCpuUtilPct());

		case "iowaitUtilPct":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getIowaitUtilPct()
							- oldRecord.getIowaitUtilPct());

		case "readIoCallRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getReadIoCallRate()
							- oldRecord.getReadIoCallRate());

		case "writeIoCallRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getWriteIoCallRate()
							- oldRecord.getWriteIoCallRate());

		case "readIoCharRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getReadIoCharRate()
							- oldRecord.getReadIoCharRate());

		case "writeIoCharRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getWriteIoCharRate()
							- oldRecord.getWriteIoCharRate());

		case "readIoByteRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getReadIoByteRate()
							- oldRecord.getReadIoByteRate());

		case "writeIoByteRate":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "double", newRecord.getWriteIoByteRate()
							- oldRecord.getWriteIoByteRate());
		...
		case "cancelledWriteIoByteRate":
			return new DifferentialValueRecord(
					...
					newRecord.getCancelledWriteIoByteRate()
							- oldRecord.getCancelledWriteIoByteRate());
		...
		case "cmajflt":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_cmajflt()
							.subtract(oldRecord.get_cmajflt()));

		case "cminflt":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_cminflt()
							.subtract(oldRecord.get_cminflt()));

		case "cstime":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_cstime()
							.subtract(oldRecord.get_cstime()));

		case "cutime":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_cutime()
							.subtract(oldRecord.get_cutime()));
		...
		case "delayacct_blkio_ticks":
			return new DifferentialValueRecord(
					...
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord
							.get_delayacct_blkio_ticks().subtract(
									oldRecord.get_delayacct_blkio_ticks()));

		case "guest_time":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_guest_time()
							.subtract(oldRecord.get_guest_time()));

		case "majflt":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_majflt()
							.subtract(oldRecord.get_majflt()));

		case "minflt":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_minflt()
							.subtract(oldRecord.get_minflt()));

		case "stime":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_stime()
							.subtract(oldRecord.get_stime()));

		case "utime":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_utime()
							.subtract(oldRecord.get_utime()));

		case "vsize":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_vsize()
							.subtract(oldRecord.get_vsize()));

		case "rss":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_rss()
							.subtract(oldRecord.get_rss()));

		case "rsslim":
			return new DifferentialValueRecord(
					oldRecord.getPreviousTimestamp(), oldRecord.getTimestamp(),
					newRecord.getPreviousTimestamp(), newRecord.getTimestamp(),
					getName(), metric, "BigInteger", newRecord.get_rsslim()
							.subtract(oldRecord.get_rsslim()));
